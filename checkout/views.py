...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        # print (intent)  - od tuka i doaga vo context 'client_secret': intent.client_secret
        
        # check whether the user is authenticated and if so we'll get their profile and use the initial parameter on the order form
        # to pre-fill all its fields with the relevant information.
        # We can fill in the full_name with the built in get_full_name method on their user account.
        ...
        if request.user.is_authenticated:
            try:
                ...
                order_form = OrderForm(initial={
                    'full_name': profile.user.get_full_name(),  # full_name i email se zimaat od User modelot
